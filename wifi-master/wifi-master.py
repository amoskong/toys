...
# Editor: Amos Kong <kongjianjun@gmail.com>
#
# Update on Thu Jun 16 06:05:53 CST 2016
...
def main():
    ...
    if len(sys.argv) > 2:
        print 'new'
        wifi.add_ssid(sys.argv[1], sys.argv[2])
    else:
        #wifi.add_ssid("aa:bb:cc:dd:ee:ff", "SSID")
        #wifi.add_ssid("ab:bc:cd:de:ef:fa", "中文SSID")
        wifi.add_ssid("8c:be:be:30:44:20", "FAST_46A640")
